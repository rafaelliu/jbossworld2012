...
# copy packages
cp "/home/rliu/Documents/authoring/GSS Bootcamp/demo/portlet-feed/target/portlet-feed.war" "$DEMO_DIR/"
cp "/home/rliu/Documents/authoring/GSS Bootcamp/demo/extension-epp/ear/target/extension-epp.ear" "$DEMO_DIR/"
